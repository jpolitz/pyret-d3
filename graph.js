...
requirejs.undef("@js-http/" + baseUrl + "graph.js");
define(["js/runtime-util", "trove/image-lib", "js/js-numbers", "d3",
    "my/d3-tip/index", "my/d3-shared"],

    function(util, imageLib, jsnums, d3, d3tip, clib){
        ...
        function treeDiagram(rt) {
            /*
             * Part of this function is adapted from:
             * http://www.d3noob.org/2014/01/tree-diagrams-in-d3js_11.html
             */
            return function (rootNode, treeOptions) {
        ...
        return function(rt, namespace) {
            ...
            return util.makeModuleReturn(rt, {}, {
                "tree-diagram": rt.makeFunction(
                    treeDiagram(rt)),
                "force-layout": rt.makeFunction(
                    forceLayout(rt, image))
            });
        };
    });