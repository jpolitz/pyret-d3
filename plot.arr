...
import shared-gdrive("plot-structs.arr", "0Bxr4FfLa3goOWjZGRzJYdjJwZkE") as P
import js-http("https://cs.brown.edu/~sporncha/pyret-d3/plot.js") as J
...
fun plot(lst :: List<Plot>, win-options :: PlotWindowOptions) -> List<Plot>:
